...
position:
  left: "76%"
  top: "40%"
description: "A text formatter for fixed-width output; J.F.O. for its author"
---
...
[RUNOFF](https://en.wikipedia.org/wiki/TYPSET_and_RUNOFF). Ossanna later
extended `nroff` into `troff` (see [#17](#annotation-17-troff)) to drive
